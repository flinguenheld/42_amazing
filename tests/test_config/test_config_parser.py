...
# #############################################################################
# ############################################################# EMPTY FILE ####
def test_config_parser_file_empty():
...
# #############################################################################
# ########################################################## VALUE MISSING ####
def test_config_parser_missing_field():
    with pytest.raises(ValueError):
        cfg = ConfigParser(
...
# #############################################################################
# ########################################################## INVALID ENTRY ####
def test_config_parser_negative_entry():
    with pytest.raises(ValueError):
        cfg = ConfigParser(
...
def test_config_parser_entry_outside_the_maze():
    with pytest.raises(ValueError):
        cfg = ConfigParser(
...
def test_config_parser_entry_row_cannot_be_equal_to_max_row():
    with pytest.raises(ValueError):
        cfg = ConfigParser(
...
# #############################################################################
# ########################################################### INVALID EXIT ####
def test_config_parser_negative_exit():
    with pytest.raises(ValueError):
        cfg = ConfigParser(
...
def test_config_parser_exit_outside_the_maze():
    with pytest.raises(ValueError):
        cfg = ConfigParser(
...
def test_config_parser_exit_col_cannot_be_equal_to_max_col():
    with pytest.raises(ValueError):
        cfg = ConfigParser(
...
def test_config_parser_height_minus_5():
    with pytest.raises(ValueError):
        cfg = ConfigParser(
...
# #############################################################################
# ########################################################## INVALID WIDTH ####
def test_config_parser_width_0():
    with pytest.raises(ValueError):
